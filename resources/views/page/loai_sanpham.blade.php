								...
								<div class="col-sm-4">
									...
									@if($sp->price_promotion!=0)
										...
										<div class="single-item-header">
											<a href="{{route('chitietsanpham',$sp->idSamPham)}}"><img style="height:300px" src="source/assets/dest/images/products/Phone/{{$sp->Anh1}}" alt=""></a>
										</div>
							...
							@foreach($sp_khac as $sp_k)
								<div class="col-sm-4">
									...
									@if($sp_k->price_promotion!=0)
											...
											@endif
										<div class="single-item-header">
											<a href="{{route('chitietsanpham',$sp->idSamPham)}}"><img style="height:300px" src="source/assets/dest/images/products/Phone/{{$sp_k->Anh1}}" alt=""></a>
										</div>
										<div class="single-item-body">
